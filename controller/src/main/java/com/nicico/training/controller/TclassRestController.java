...
//    @PreAuthorize("hasAuthority('u_tclass')")
    ...
    @Loggable
    @GetMapping(value = "/calenderClass-spec-list")
    public ResponseEntity<TclassDTO.TclassSpecRs> listByCalenderClass(@RequestParam(value = "_startRow", defaultValue = "0") Integer startRow,
                                                                 @RequestParam(value = "_endRow", defaultValue = "50") Integer endRow,
                                                                 HttpServletRequest iscRq) throws IOException, NoSuchFieldException, IllegalAccessException {
