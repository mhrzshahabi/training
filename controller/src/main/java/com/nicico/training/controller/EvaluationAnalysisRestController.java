...
//                        for (int z=0 ; z<subV2.size();z++) {
                            ViewEvaluationStaticalReportDTO.Info info=subV2.get(0);

                            chartData.add(new ChartData(PersianCharachtersUnicode.bidiReorder(info.getCourseTitleFa()) + "/" + info.getTclassCode(), 0+1 + "" ,
