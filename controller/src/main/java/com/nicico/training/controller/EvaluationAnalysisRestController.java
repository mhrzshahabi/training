                ...
                if (list.size()>5){
                    ...
                    for (int m=0 ; m<subLists.size();m++){
                        ...
                        for (int z=0 ; z<subV2.size();z++) {
                            ...
                            chartData.add(new ChartData( info.getTclassCode()+ "("+info.getPercentOfReaction()+"% )" , z+1 + "" ,
                    ...
                    for (ViewEvaluationStaticalReportDTO.Info info : list) {
                        chartData.add(new ChartData( info.getTclassCode()+ "("+info.getPercentOfReaction()+"% )" , index + "",
