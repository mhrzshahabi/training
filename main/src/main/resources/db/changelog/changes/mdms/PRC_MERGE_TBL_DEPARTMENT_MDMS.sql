...
MERGE INTO TBL_DEPARTMENT T
    USING
        (SELECT MDMS_DEPARTMENT.C_CODE               AS MDMS_C_CODE,
                ...
                MDMS_DEPARTMENT.C_TITLE_DSEC              AS MDMS_C_TITLE,
         ...
         WHERE TR_DEPARTMENT.C_TITLE <> MDMS_DEPARTMENT.C_TITLE_DSEC
            ...
            OR TR_DEPARTMENT.C_TITLE <> MDMS_DEPARTMENT.C_TITLE_DSEC
            OR (TR_DEPARTMENT.C_TITLE IS NULL
             AND MDMS_DEPARTMENT.C_TITLE_DSEC IS NOT NULL)
            OR (TR_DEPARTMENT.C_TITLE IS NOT NULL
             AND MDMS_DEPARTMENT.C_TITLE_DSEC IS NULL)
