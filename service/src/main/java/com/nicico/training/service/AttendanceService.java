...
public class AttendanceService implements IAttendanceService {
    ...
    public List<List<Map>> autoCreate(Long classId, String date) {
        ...
        for (ClassStudent classStudent : tclass.getClassStudents()) {
            ...
            map.put("personalNum2", classStudent.getStudent().getPersonnelNo2());
            ...
            map.put("classStudentAffairs", classStudent.getStudent().getCcpAffairs());
            map.put("classStudentCompany", classStudent.getStudent().getCompanyName());
