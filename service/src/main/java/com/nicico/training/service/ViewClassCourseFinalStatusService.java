...
@Service
public class ViewClassCourseFinalStatusService implements IViewClassCourseFinalStatusService {
    private final ViewClassCourseFinalStatusDAO viewClassCourseFinalStatusDAO;
    ...
    public <T> SearchDTO.SearchRs<T> search(SearchDTO.SearchRq request, Function converter) {
        ...
        return SearchUtil.search(viewClassCourseFinalStatusDAO, request, converter);
    }
