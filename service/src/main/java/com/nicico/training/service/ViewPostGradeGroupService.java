...
@Service
public class ViewPostGradeGroupService extends BaseService<ViewPostGradeGroup, Long, ViewPostGradeGroupDTO.Info, ViewPostGradeGroupDTO.Info, ViewPostGradeGroupDTO.Info, ViewPostGradeGroupDTO.Info, ViewPostGradeGroupDAO>{
    @Autowired
