...
//        classStudentHistoryService.saveList(studentList);
    ...
    public ElsClassListDto getTeacherClasses(String nationalCode, Integer page, Integer size) {
        ...
        if (nationalCode!=null && !nationalCode.isEmpty() ) {
            List<Object> list = classStudentDAO.findAllClassByTeacher(Long.valueOf(nationalCode), page + 1, size);
            long count = classStudentDAO.findAllCountClassByTeacher(Long.valueOf(nationalCode)).size();
            long totalPage = 0;
            if (count != 0 && size != 0) {
    ...
    public ElsClassListDto getStudentClasses(String nationalCode, Integer page, Integer size) {
        ElsClassListDto dto = new ElsClassListDto();
        if (nationalCode!=null && !nationalCode.isEmpty() ) {
            List<Object> list = classStudentDAO.findAllClassByStudent(Long.valueOf(nationalCode), page + 1, size);
            long count = classStudentDAO.findAllCountClassByStudent(Long.valueOf(nationalCode)).size();
            long totalPage = 0;
            if (count != 0 && size != 0) {
                totalPage = count / size;
            }
    ...
    public Long getStudentId(Long classId, String nationalCode) {
        if (nationalCode!=null && !nationalCode.isEmpty() ){
        List<Long> studentIds = classStudentDAO.getClassStudentIdByClassCodeAndNationalCode(classId, Long.valueOf(nationalCode));
