...
// <script>
    ...
    var RestDataSource_PostGradeLvl_PCNR = isc.TrDS.create({
        fields: [
            ...
            {name: "peopleType",  title: "نوع فراگیر",valueMap: peopleTypeMap},
    ...
    DynamicForm_SelectPostGrade_JspUnitReport.getField("PostGrade.code").setHint("رده پستی مورد نظر را انتخاب کنید");
    ...
    IButton_ConfirmPostGradeSelections_JspUnitReport = isc.IButtonSave.create({
        ...
        click: function () {
            ...
            var selectorDisplayValues = DynamicForm_SelectPostGrade_JspUnitReport.getItem("PostGrade.code").getValue();
            criteriaDisplayValuesPostGrade = selectorDisplayValues;

            if (selectorDisplayValues != null) {
                DynamicForm_CriteriaForm_JspcontinuousPersonnel.getField("postGrade").setValue(selectorDisplayValues);
            } else {
                DynamicForm_CriteriaForm_JspcontinuousPersonnel.getField("postGrade").setValue([]);
            }
    ...
    IButton_CancelPostGradeSelections_JspUnitReport = isc.IButtonCancel.create({
        top: 260,
        title: "انصراف",
        width: 150,
        click: function () {
                ...
                members: [
                    ...
                    isc.HLayout.create({
                        ...
                        members: [
                            ...
                            IButton_CancelPostGradeSelections_JspUnitReport
                        ]
                    })
                ]
            })
