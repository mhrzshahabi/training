...
//------
        ...
        fields: [
...

            {
                ...
                valueMap: ["قبول با نمره", "قبول بدون نمره","قبول ارزشی", "مردود"],
        ...
        dataArrived: function () {
          ...
          //  totalsLabel_scores.setContents("روش نمره دهی" + ":&nbsp;<b>" + myMap.get(classRecord.scoringMethod) + "</b>" + "&nbsp;&nbsp;&nbsp;&nbsp;" + "حد قبولی" + ":&nbsp;<b>" + (classRecord.acceptancelimit) + "</b>");
        },
