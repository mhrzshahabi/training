...
// <script>
    ...
    RestDataSource_JspAttendanceReport = isc.TrDS.create({
        fields: [
            ...
            {name: "studentNationalCode", title:"<spring:message code='national.code'/>", filterOperator: "iContains", width: "10%"},
            {name: "presenceHour", title:"حضور بر حسب ساعت", filterOperator: "equals", width: "10%"},
            {name: "presenceMinute", title:"حضور بر حسب دقیقه", filterOperator: "equals", width: "10%"},
            {name: "absenceHour", title:"غیبت بر حسب ساعت", filterOperator: "equals", width: "10%"},
            {name: "absenceMinute", title:"غیبت بر حسب دقیقه", filterOperator: "equals", width: "10%"},
            {name: "classId", hidden: true, filterOperator: "equals", width: "10%"},
            {name: "classCode", title:"<spring:message code="class.code"/>", filterOperator: "inSet", width: "10%"},
            {name: "classStartDate", title:"<spring:message code="start.date"/>", filterOperator: "iContains", width: "10%"},
            {name: "classEndDate", title:"<spring:message code="end.date"/>", filterOperator: "iContains", width: "10%"},
            {name: "classTeachingType", title:"<spring:message code="teaching.type"/>", filterOperator: "iContains", width: "10%"},
            {name: "sessionDate", title:"تاریخ جلسه", filterOperator: "iContains", width: "10%"},
            {name: "studentId", hidden: true, filterOperator: "equals", width: "10%"},
            {name: "studentPersonnelNo", title:"<spring:message code='personnel.no'/>", filterOperator: "iContains", width: "10%"},
            {name: "studentPersonnelNo2", title:"<spring:message code='personnel.no.6.digits'/>", filterOperator: "iContains", width: "10%"},
            {name: "studentCcpAssistant", title:"<spring:message code='assistance'/>", filterOperator: "iContains", width: "10%"},
            {name: "studentCcpAffairs", title: "<spring:message code="affairs"/>", filterOperator: "iContains", width: "10%"},
            {name: "studentCcpSection", title:"<spring:message code='section'/>", filterOperator: "iContains", width: "10%"},
            {name: "studentCcpUnit", title:"<spring:message code='unit'/>", filterOperator: "iContains", width: "10%"},
            {name: "classStudentApplicantCompanyName", title:"<spring:message code='company.applicant'/>", filterOperator: "iContains", width: "10%"},
            {name: "personnelComplexTitle", title: "<spring:message code="complex"/>", filterOperator: "iContains", width: "10%"},
            {name: "courseId", hidden: true, title:"<spring:message code='identity'/>", filterOperator: "equals", width: "10%"},
            {name: "courseCode", title:"<spring:message code='course.code'/>", filterOperator: "iContains", width: "10%"},
            {name: "courseTitleFa", title:"<spring:message code='course'/>", filterOperator: "iContains", width: "10%"},
            {name: "courseRunType", title:"<spring:message code='course_eruntype'/>", filterOperator: "iContains", width: "10%"},
            {name: "courseTheoType", title:"<spring:message code='course_etheoType'/>", filterOperator: "iContains", width: "10%"},
            {name: "courseLevelType", title:"<spring:message code='cousre_elevelType'/>", filterOperator: "iContains", width: "10%"},
            {name: "courseTechnicalType", title: "<spring:message code="technical.type"/>", filterOperator: "iContains", width: "10%"},
            {name: "instituteId", hidden: true, title: "<spring:message code="identity"/>", filterOperator: "equals", width: "10%"},
