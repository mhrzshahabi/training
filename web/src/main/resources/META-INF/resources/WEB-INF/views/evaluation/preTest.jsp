    ...
    var ToolStrip_Actions_PreTest = isc.ToolStrip.create({
        ...
        members: [
            ...
            isc.IButton.create({
                ...
                margin: 3,
                click: function () {
                    loadExamForScores(ListGrid_class_Evaluation.getSelectedRecord());
                }
            }),
            isc.IButton.create({
                // disabled: !ListGrid_class_Evaluation.getSelectedRecord().onlineFinalExamStatus,
                ...
                margin: 3,
                click: function () {
                    loadExamResult(ListGrid_class_Evaluation.getSelectedRecord());
                }
            }),
            isc.IButton.create({
                ...
                margin: 3,
                click: function () {
                    showInvalidUsers(ListGrid_class_Evaluation.getSelectedRecord());
                }
            }),
