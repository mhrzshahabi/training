...
// <script>
    var tempPersonnel;
    var tempListGrid_PersonnelTraining;
    //function loadPersonnelInfo() {
    ...
    // <<-------------------------------------- Create - RestDataSource & ListGrid ----------------------------
    {
        ...
        var ListGrid_PersonnelTraining = isc.TrLG.create({
            ...
            dataArrived() {
                tempListGrid_PersonnelTraining = ListGrid_PersonnelTraining.data.getAllRows();
            }
        });
    ...
    // <<-------------------------------------- Create - TabSet & Tab -----------------------------------------
    {
        ...
        PersonnelInfo_Tab = isc.TabSet.create({
            ...
            tabSelected: function () {
                ...
                if (tab.title == '<spring:message code="personnel.information"/>') {
                    set_PersonnelInfo_Details(PersonnelList_Tab.getSelectedTab().id === "PersonnelList_Tab_Personnel" ? PersonnelInfoListGrid_PersonnelList.getSelectedRecord() : PersonnelInfoListGrid_RegisteredPersonnelList.getSelectedRecord());
                    ...
                    if (ClassStudentWin_student.isVisible()) {
                        ...
                        set_PersonnelInfo_Details(selectedRecord_addStudent_class);
                    } else {
                        let record = {
                        ...
                        set_PersonnelInfo_Details(record);
                    }
    ...
    // <<----------------------------------------------- Functions --------------------------------------------
    {
        ...
        function set_PersonnelInfo_Details(selectedPersonnel) {
            ...
            if (selectedPersonnel !== undefined && selectedPersonnel !== null) {
                ...
                if (PersonnelInfo_Tab.getSelectedTab().id === "PersonnelInfo_Tab_Info") {
                    ...
                    if (personnelNo !== null && (nationalCode_Info === nationalCode || personnelNo_Info === personnelNo) &&
                        (PersonnelInfo_Tab.getSelectedTab().id !== "PersonnelInfo_Tab_Training" || PersonnelInfo_Tab.getSelectedTab().id === "PersonnelInfo_Tab_NeedAssessment")){
                        DynamicForm_PersonnelInfo.editRecord(tempPersonnel);
                    } else if (personnelNo !== null && (nationalCode_Info !== nationalCode || personnelNo_Info !== personnelNo)) {
                        ...
                        isc.RPCManager.sendRequest(TrDSRequest(personnelUrl + "/byPersonnelNo/" + personnelNo, "GET", null, function (resp) {
                            ...
                            if (resp.httpResponseCode === 200 || resp.httpResponseCode === 201) {
                                ...
                                tempPersonnel = currentPersonnel;
                    ...
                    if (nationalCode !== null && (nationalCode_Training !== nationalCode || personnelNo_Training !== personnelNo)) {
                        ...
                        ListGrid_PersonnelTraining.setData(tempListGrid_PersonnelTraining);
                        ListGrid_PersonnelTraining.invalidateCache();
                    }
...
//!*****get selected course information*****
    ...
    if (tab.title == '<spring:message code="personnel.information"/>')
        {
            HLayout_PersonnelInfo_Details.members.add(PersonnelInfo_Tab);
        }
        else if (tab.title == '<spring:message code="class"/>')
        {
            let record = {
