...
// <script>
    ...
    var selectedShowRecord = {};
    var editingSHow = false;
    var hasSHowChanged = false;

    var skillShowData = [];
    var competenceShowData = [];
    var showPeopleTypeMap ={
        "Personal" : "شرکتی",
        "ContractorPersonal" : "پیمان کار"
    };

<%--    //----------------------------------------- DataSources --------------------------------------------------------------%>
<%--    &lt;%&ndash;let NeedsAssessmentTargetDS_needsAssessment = isc.TrDS.create({&ndash;%&gt;--%>
<%--    &lt;%&ndash;    ID: "NeedsAssessmentTargetDS_needsAssessment",&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fields: [&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "id", primaryKey: true, hidden: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "title", title: "<spring:message code="title"/>", required: true, filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "code", title: "<spring:message code="code"/>", required: true, filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;    ],&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fetchDataURL: parameterValueUrl + "/iscList/103",&ndash;%&gt;--%>
<%--    --%>
<%--    &lt;%&ndash;});&ndash;%&gt;--%>
<%--    //**********************************************************************--%>

<%--    &lt;%&ndash;let JobDs_needsAssessment = isc.TrDS.create({&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fields: [&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "id", primaryKey: true, hidden: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "code", title: "<spring:message code="code"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "titleFa", title: "<spring:message code="title"/>", filterOperator: "iContains"},&ndash;%&gt;--%>
<%--    &lt;%&ndash;    ],&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fetchDataURL: jobUrl + "/spec-list"&ndash;%&gt;--%>
<%--    &lt;%&ndash;});&ndash;%&gt;--%>
<%--    //**********************************************************************--%>

<%--    &lt;%&ndash;let JobGroupDs_needsAssessment = isc.TrDS.create({&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fields: [&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "id", primaryKey: true, hidden: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "titleFa", title: "<spring:message code="title"/>", filterOperator: "iContains"},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "code", title: "<spring:message code="code"/>", filterOperator: "iContains"},&ndash;%&gt;--%>
<%--    &lt;%&ndash;    ],&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fetchDataURL: jobGroupUrl + "iscList"&ndash;%&gt;--%>
<%--    &lt;%&ndash;});     &ndash;%&gt;--%>
<%--    //**********************************************************************--%>
<%--    &lt;%&ndash;let PostDs_needsAssessment = isc.TrDS.create({&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fields: [&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "id", primaryKey: true, hidden: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "code", title: "<spring:message code="post.code"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "titleFa", title: "<spring:message code="post.title"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "job.titleFa", title: "<spring:message code="job.title"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "postGrade.titleFa", title: "<spring:message code="post.grade.title"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "area", title: "<spring:message code="area"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "assistance", title: "<spring:message code="assistance"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "affairs", title: "<spring:message code="affairs"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "section", title: "<spring:message code="section"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "unit", title: "<spring:message code="unit"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "costCenterCode", title: "<spring:message code="reward.cost.center.code"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;        {name: "costCenterTitleFa", title: "<spring:message code="reward.cost.center.title"/>", filterOperator: "iContains", autoFitWidth: true},&ndash;%&gt;--%>
<%--    &lt;%&ndash;    ],&ndash;%&gt;--%>
<%--    &lt;%&ndash;    fetchDataURL: postUrl + "/spec-list"&ndash;%&gt;--%>
<%--    &lt;%&ndash;});&ndash;%&gt;--%>
<%--    //**********************************************************************--%>

    let ShowPostDS_TrainingPost = isc.TrDS.create({
        fields: [
            {name: "id", primaryKey: true, hidden: true},
            {name: "peopleType", title: "<spring:message code="people.type"/>", filterOperator: "equals", autoFitWidth: true, valueMap:showPeopleTypeMap},
...
<%--    //**********************************************************************--%>
    ...
    var ShowRestDataSource_Skill_JspNeedsAssessment = isc.TrDS.create({
        ID: "ShowRestDataSource_Skill_JspNeedsAssessment",
        fields: [
            {name: "id", primaryKey: true, hidden: true},
...
<%--    //**********************************************************************--%>
    ...
    var ShowDataSource_Competence_JspNeedsAssessment = isc.DataSource.create({
        clientOnly: true,
        fields: [
            {name: "id", primaryKey: true, hidden: true},
            {name: "title", title: "<spring:message code="title"/>", filterOperator: "iContains", autoFitWidth: true},
        ...
        testData: competenceShowData,
        // fetchDataURL: competenceUrl + "/iscList",
    });
<%--    //**********************************************************************--%>

    var ShowDataSource_Skill_JspNeedsAssessment = isc.DataSource.create({
        ID: "ShowDataSource_Skill_JspNeedsAssessment",
        fields: [
            {name: "id", hidden:true},
            ...
            {name: "objectType", title: "<spring:message code="reference"/>", primaryKey: true, filterOperator: "iContains", valueMap: priorityList, autoFitWidth:true,
                ...
                sortNormalizer(record){
                    if(record.objectType === showDynamicForm_JspEditNeedsAssessment.getValue("objectType")){
                        return 0;
                    }
                    return 1;
                }
...
<%--                title:"افزودن",--%>
<%--                click: function () {--%>
<%--                    if(showDynamicForm_JspEditNeedsAssessment.getValue("objectId")!=null) {--%>
...
<%--        click: function () {--%>
<%--            let id = showDynamicForm_JspEditNeedsAssessment.getValue("objectId");--%>
<%--            let type = showDynamicForm_JspEditNeedsAssessment.getValue("objectType");--%>
<%--            wait.show();--%>

<%--            isc.RPCManager.sendRequest(TrDSRequest(needsAssessmentUrl + "/rollBack/" + type + "/" + id, "PUT", null, (resp)=>{--%>
<%--                wait.close();--%>
<%--                if(resp.httpResponseCode === 200){--%>
<%--                    hasSHowChanged = false;--%>
<%--                    canSendToWorkFlowNA = false;--%>
<%--                    showEditNeedsAssessmentRecord(id, type);--%>
<%--                }--%>
<%--            }));--%>
<%--        }--%>
<%--    });--%>
...
<%--    //**********************************************************************--%>
    ...
    var showLabel_PlusData_JspNeedsAssessment = isc.LgLabel.create({
        align:"left",
        contents:"",
        margin:8,
        customEdges: []});
    var ShowLabel_Help_JspNeedsAssessment = isc.LgLabel.create({
        align:"left",
        width: "50%",
...
<%--        // borderRadius: 5,--%>
<%--        click(){--%>
<%--            if(ShowListGrid_Knowledge_JspNeedsAssessment.getSelectedRecord()||ShowListGrid_Ability_JspNeedsAssessment.getSelectedRecord()||ShowListGrid_Attitude_JspNeedsAssessment.getSelectedRecord()||ShowListGrid_SkillAll_JspNeedsAssessment.getSelectedRecord()){--%>
<%--                let skillIds = [];--%>
<%--                if(ShowListGrid_Knowledge_JspNeedsAssessment.getSelectedRecord()!= undefined && ShowListGrid_Knowledge_JspNeedsAssessment.getSelectedRecord().course != undefined) {--%>
<%--                    skillIds.push(ShowListGrid_Knowledge_JspNeedsAssessment.getSelectedRecord().skillId);--%>
<%--                }--%>
<%--                if(ShowListGrid_Ability_JspNeedsAssessment.getSelectedRecord()!= undefined && ShowListGrid_Ability_JspNeedsAssessment.getSelectedRecord().course!= undefined) {--%>
<%--                    skillIds.push(ShowListGrid_Ability_JspNeedsAssessment.getSelectedRecord().skillId);--%>
<%--                }--%>
<%--                if(ShowListGrid_Attitude_JspNeedsAssessment.getSelectedRecord()!= undefined && ShowListGrid_Attitude_JspNeedsAssessment.getSelectedRecord().course!= undefined) {--%>
<%--                    skillIds.push(ShowListGrid_Attitude_JspNeedsAssessment.getSelectedRecord().skillId);--%>
<%--                }--%>
<%--                if(ShowListGrid_SkillAll_JspNeedsAssessment.getSelectedRecord()!= undefined && ShowListGrid_SkillAll_JspNeedsAssessment.getSelectedRecord().course!= undefined) {--%>
<%--                    skillIds.push(ShowListGrid_SkillAll_JspNeedsAssessment.getSelectedRecord().id);--%>
<%--                }--%>
...
<%--        click: function () {--%>
<%--            wait.show();--%>
<%--            showWindowDiffNeedsAssessment(showDynamicForm_JspEditNeedsAssessment.getValue("objectId"), showDynamicForm_JspEditNeedsAssessment.getValue("objectType"), null,true)--%>
<%--        }--%>
<%--    });--%>
...
<%--                title: "جزییات دوره",--%>
<%--                click: function () {--%>
<%--                    if(selectedShowRecord.course !== undefined) {--%>
<%--                        let id = selectedShowRecord.course.id;--%>
<%--                        wait.show()--%>
...
<%--                                },--%>
<%--                                &lt;%&ndash;{&ndash;%&gt;--%>
<%--                                &lt;%&ndash;name: "workflowStatusCode",&ndash;%&gt;--%>
<%--                                &lt;%&ndash;title: "<spring:message code="status"/>",&ndash;%&gt;--%>
<%--                                &lt;%&ndash;align: "center",&ndash;%&gt;--%>
<%--                                &lt;%&ndash;autoFitWidth: true,&ndash;%&gt;--%>
<%--                                &lt;%&ndash;filterOperator: "iContains",&ndash;%&gt;--%>
...
<%--                title: "ویرایش دوره",--%>
<%--                click: function () {--%>
<%--                    if(selectedShowRecord.objectType === showDynamicForm_JspEditNeedsAssessment.getValue("objectType")) {--%>
...
<%--                                    operator: "and",--%>
<%--                                    criteria: [--%>
<%--                                        {fieldName: "categoryId", operator: "equals", value: selectedShowRecord.skill.categoryId},--%>
<%--                                        {fieldName: "subCategoryId", operator: "equals", value: selectedShowRecord.skill.subCategoryId},--%>
<%--                                    ]--%>
<%--                                }--%>
...
<%--                                    if(selectedShowRecord.skill.courseId !== undefined){--%>
<%--                                        oldCourseRecord = ListGrid_AddCourse_JspENA.getData().localData.toArray().find(a=>a.id===selectedShowRecord.skill.courseId);--%>
...
<%--                                                if(state){--%>
<%--                                                    if((selectedShowRecord.skill.courseId == null)||(record.id !== selectedShowRecord.skill.courseId)){--%>
<%--                                                        let dialog = createDialog("ask", "از تغییر دوره مهارت " + selectedShowRecord.skill.titleFa + " به دوره انتخاب شده مطمئن هستید.");--%>
<%--                                                        dialog.addProperties({--%>
<%--                                                            buttonClick: function (button, index) {--%>
<%--                                                                this.close();--%>
<%--                                                                if (index === 0) {--%>
<%--                                                                    let url = skillUrl + "/add-course/" + record.id + "/" + selectedShowRecord.skillId;--%>
<%--                                                                    wait.show();--%>
...
<%--                                                                        }--%>
<%--                                                                        showEditNeedsAssessmentRecord(showDynamicForm_JspEditNeedsAssessment.getValue("objectId"), showDynamicForm_JspEditNeedsAssessment.getValue("objectType"));--%>
<%--                                                                        ShowListGrid_SkillAll_JspNeedsAssessment_Refresh();--%>
...
<%--                    }--%>
<%--                    else{--%>
<%--                        createDialog("info","فقط نیازسنجی های مرتبط با "+priorityList[showDynamicForm_JspEditNeedsAssessment.getValue("objectType")]+" قابل تغییر است.")--%>
<%--                    }--%>
<%--                }--%>
<%--            },--%>
<%--            {isSeparator: true},--%>
...
<%--                    if(ShowListGrid_Knowledge_JspNeedsAssessment.containsFocus())--%>
<%--                        records  = ShowListGrid_Knowledge_JspNeedsAssessment.getSelectedRecords();--%>
<%--                    if(ShowListGrid_Ability_JspNeedsAssessment.containsFocus())--%>
<%--                        records  = ShowListGrid_Ability_JspNeedsAssessment.getSelectedRecords();--%>
<%--                    if(ShowListGrid_Attitude_JspNeedsAssessment.containsFocus())--%>
<%--                        records  = ShowListGrid_Attitude_JspNeedsAssessment.getSelectedRecords();--%>
...
<%--                click: function () {--%>
<%--                    if(checkSelectedRecord(ShowListGrid_Competence_JspNeedsAssessment)) {--%>
<%--                        ShowListGrid_Competence_JspNeedsAssessment.rowDoubleClick(ShowListGrid_Competence_JspNeedsAssessment.getSelectedRecord())--%>
<%--                    }--%>
<%--                }--%>
<%--            },--%>
<%--        ]--%>
...
<%--                        + "/" + record.objectId + "/" + showDynamicForm_JspEditNeedsAssessment.getValue("objectType")--%>
<%--                        + "/" + showDynamicForm_JspEditNeedsAssessment.getValue("objectId")--%>
...
<%--                            return;--%>
<%--                        }--%>
<%--                        showEditNeedsAssessmentRecord(showDynamicForm_JspEditNeedsAssessment.getValue("objectId"),showDynamicForm_JspEditNeedsAssessment.getValue("objectType"), JSON.parse(resp.data));--%>
<%--                        hasSHowChanged = true;--%>
<%--                        canSendToWorkFlowNA = true;--%>
<%--                    }));--%>
<%--                }--%>
...
<%--                    let record = ShowListGrid_SkillAll_JspNeedsAssessment.getSelectedRecord();--%>
...
<%--            if (checkSaveData(record, ShowDataSource_Competence_JspNeedsAssessment, "id")) {--%>
<%--                ShowListGrid_Competence_JspNeedsAssessment.transferSelectedData(this);--%>
<%--                return;--%>
<%--            }--%>
...
<%--    //**********************************************************************--%>
    ...
    let ShowListGrid_Competence_JspNeedsAssessment = isc.TrLG.create({
        ID: "ShowListGrid_Competence_JspNeedsAssessment",
        dataSource: ShowDataSource_Competence_JspNeedsAssessment,
        autoFetchData: true,
        ...
        <%--                    this.close();--%>
        <%--                    if (index === 0) {--%>
        <%--                        let data = ShowListGrid_Knowledge_JspNeedsAssessment.data.localData.toArray();--%>
        <%--                        data.addAll(ShowListGrid_Attitude_JspNeedsAssessment.data.localData.toArray());--%>
        <%--                        data.addAll(ShowListGrid_Ability_JspNeedsAssessment.data.localData.toArray());--%>
        <%--                        let hasFather = false;--%>
        ...
        <%--                        }--%>
        <%--                        if(hasFather===false) {--%>
        <%--                            ShowListGrid_Competence_JspNeedsAssessment.removeData(ShowListGrid_Competence_JspNeedsAssessment.getRecord(rowNum));--%>
        <%--                        }--%>
        <%--                    }--%>
        <%--                }--%>
        <%--            });--%>
...
<%--    //**********************************************************************--%>
    ...
    let ShowListGrid_SkillAll_JspNeedsAssessment = isc.TrLG.create({
        ID: "ShowListGrid_SkillAll_JspNeedsAssessment",
        dataSource: ShowRestDataSource_Skill_JspNeedsAssessment,
...
<%--    //**********************************************************************--%>
    ...
    let ShowListGrid_Knowledge_JspNeedsAssessment = isc.ListGrid.create({
        ID: "ShowListGrid_Knowledge_JspNeedsAssessment",
        autoFetchData:false,
        dataSource: ShowDataSource_Skill_JspNeedsAssessment,
        showRowNumbers: false,
        ...
        <%--    let record = ShowListGrid_Competence_JspNeedsAssessment.getSelectedRecord();--%>
        <%--    if (checkRecordAsSelected(record, true, "<spring:message code="competence"/>")) {--%>
        <%--        if (sourceWidget.ID === 'ShowListGrid_SkillAll_JspNeedsAssessment') {--%>
...
<%--    //**********************************************************************--%>
    ...
    let ShowListGrid_Ability_JspNeedsAssessment = isc.ListGrid.create({
        ID: "ShowListGrid_Ability_JspNeedsAssessment",
        dataSource: ShowDataSource_Skill_JspNeedsAssessment,
        autoFetchData:false,
        showRowNumbers: false,
        // contextMenu: Menu_ListGrid_JspENA,
...
<%--    //**********************************************************************--%>
    ...
    let ShowListGrid_Attitude_JspNeedsAssessment = isc.ListGrid.create({
        ID: "ShowListGrid_Attitude_JspNeedsAssessment",
        dataSource: ShowDataSource_Skill_JspNeedsAssessment,
        showHeaderContextMenu: false,
        showRowNumbers: false,
        autoFetchData:false,
        ...
        <%--                // ShowDataSource_Skill_JspNeedsAssessment.addData(data);--%>
...
<%--    //**********************************************************************--%>
    ...
    let showDynamicForm_JspEditNeedsAssessment = isc.DynamicForm.create({
        ID: "showDynamicForm_JspEditNeedsAssessment",
        numCols: 2,
        ...
        fields: [
            ...
            //             showLabel_PlusData_JspNeedsAssessment.setContents("");
            //             // refreshPersonnelLG();
            //         }
            //     },
            // },
            {
                name: "objectId",
                title: "پست: ",
                optionDataSource: ShowPostDS_TrainingPost,
                ...
                changed: function (form, item, value, oldValue) {
                    if(value !== oldValue){
                        showEditNeedsAssessmentRecord(showDynamicForm_JspEditNeedsAssessment.getValue("objectId"),
                            "TrainingPost"
                            // ,showDynamicForm_JspEditNeedsAssessment.getValue("objectType")
                        );
                        // refreshPersonnelLG();
                        showUpdateLabelEditNeedsAssessment(item.getSelectedRecord());
                    }
                },
            },
...
<%--                            + "/" + DynamicForm_CopyOf_JspEditNeedsAssessment.getValue("objectId") + "/" + showDynamicForm_JspEditNeedsAssessment.getValue("objectType")--%>
<%--                            + "/" + showDynamicForm_JspEditNeedsAssessment.getValue("objectId");--%>
<%--                        wait.show();--%>
<%--                        isc.RPCManager.sendRequest(TrDSRequest(url, "GET", null,(resp)=>{--%>
<%--                            wait.close();--%>
...
<%--    //**********************************************************************--%>
    ...
    let ShowHLayout_Label_PlusData_JspNeedsAssessment = isc.TrHLayout.create({
        height: "1%",
        padding:2,
        members: [
            ...
            showLabel_PlusData_JspNeedsAssessment,
        ],
    });
<%--    //**********************************************************************--%>
...
<%--    //**********************************************************************--%>
    ...
    let ShowHLayout_Bottom = isc.TrHLayout.create({
        members: [
            isc.TrVLayout.create({
                width: "25%",
                showResizeBar: true,
                members: [
                    ShowListGrid_Competence_JspNeedsAssessment
                ]
            }),
            isc.TrVLayout.create({
                ID: "ShowVLayoutLeft_JspEditNeedsAssessment",
                // width: "75%",
                members: [
                    isc.TrHLayout.create({
                        ID: "ShowHLayoutCenter_JspEditNeedsAssessment",
                        height: "70%",
                        showResizeBar: true,
                        members: [
                            ShowListGrid_Knowledge_JspNeedsAssessment,
                            ShowListGrid_Ability_JspNeedsAssessment,
                            ShowListGrid_Attitude_JspNeedsAssessment
                        ]
                    }),
                    isc.HLayout.create({
                        height: "5%",
                        showResizeBar: true,
                        members: [
                            ShowLabel_Help_JspNeedsAssessment,
                            // isc.Button.create({
                            //     width: "140",
                            //     align: "left",
                            //     margin: 2,
                            ...
                            //     click: function () {
                            //
                            //         if (ShowListGrid_Knowledge_JspNeedsAssessment.data.localData!== undefined
                            //             && ShowListGrid_Attitude_JspNeedsAssessment.data.localData!== undefined
                            //             && ShowListGrid_Ability_JspNeedsAssessment.data.localData!== undefined)
                            //         {
                    ...
                    ShowListGrid_SkillAll_JspNeedsAssessment
                ]
            })
        ]
    });
<%--    //**********************************************************************--%>
    ...
    isc.TrVLayout.create({
        members: [
            showDynamicForm_JspEditNeedsAssessment,
            ShowHLayout_Label_PlusData_JspNeedsAssessment,
            ShowHLayout_Bottom,
...
<%--                break;--%>
<%--            case 'TrainingPost':--%>
<%--                form.getItem("objectId").optionDataSource = ShowPostDS_TrainingPost;--%>
<%--                form.getItem("objectId").pickListFields = [--%>
<%--                    {name: "code", keyPressFilter: false}, {name: "titleFa"}, {name: "job.titleFa"}, {name: "postGrade.titleFa"}, {name: "area"}, {name: "assistance"}, {name: "affairs"},--%>
<%--                    {name: "section"}, {name: "unit"}, {name: "costCenterCode"}, {name: "costCenterTitleFa"}--%>
<%--                ];--%>
...
<%--    //**********************************************************************--%>
    ...
    function clearAllShowGrid() {
        competenceShowData.length = 0;
        skillShowData.length = 0;
        ShowListGrid_Competence_JspNeedsAssessment.setData([]);
        ShowListGrid_Knowledge_JspNeedsAssessment.setData([]);
        ShowListGrid_Attitude_JspNeedsAssessment.setData([]);
        ShowListGrid_Ability_JspNeedsAssessment.setData([]);
    }
<%--    //**********************************************************************--%>
...
<%--    //**********************************************************************--%>
    ...
    function showFetchDataDomainsGrid(){
        let record = ShowListGrid_Competence_JspNeedsAssessment.getSelectedRecord();
        if(record != null) {
            ShowListGrid_Knowledge_JspNeedsAssessment.fetchData({"competenceId":record.id});
            ShowListGrid_Knowledge_JspNeedsAssessment.invalidateCache();

            ShowListGrid_Ability_JspNeedsAssessment.fetchData({"competenceId":record.id});
            ShowListGrid_Ability_JspNeedsAssessment.invalidateCache();

            ShowListGrid_Attitude_JspNeedsAssessment.fetchData({"competenceId":record.id});
            ShowListGrid_Attitude_JspNeedsAssessment.invalidateCache();
        }
    }
<%--    //**********************************************************************--%>
...
<%--        if(record.objectType === showDynamicForm_JspEditNeedsAssessment.getValue("objectType")){--%>
<%--            wait.show();--%>
<%--            ShowDataSource_Skill_JspNeedsAssessment.removeData(record);--%>
<%--            hasSHowChanged = true;--%>
<%--            canSendToWorkFlowNA = true;--%>
<%--            wait.close();--%>
<%--            return 1;--%>
...
<%--        else{--%>
<%--            if(state === 0) {--%>
<%--                createDialog("info", "فقط نیازسنجی های با مرجع " +'<u><b>'+ priorityList[showDynamicForm_JspEditNeedsAssessment.getValue("objectType")] +'</u></b>'+ " قابل حذف است.")--%>
<%--            }--%>
<%--            return 2;--%>
<%--        }--%>
<%--    }--%>
<%--    //**********************************************************************--%>
    ...
    function showEditNeedsAssessmentRecord(objectId, objectType, data) {
        updateObjectIdLG(showDynamicForm_JspEditNeedsAssessment, objectType);
        clearAllShowGrid();
        if(!data)
            isc.RPCManager.sendRequest(TrDSRequest(needsAssessmentUrl + "/editList/" + objectType + "/" + objectId,
                "GET", null, r => showResponseToListGrid_All_JspNeedsAssessment(objectId, objectType,
            ...
            showResponseToListGrid_All_JspNeedsAssessment(objectId, objectType, data);
        }
    }
<%--    //**********************************************************************--%>

    function showResponseToListGrid_All_JspNeedsAssessment(objectId, objectType, data) {
        let flags  = [];
        for (let i = 0; i < data.length; i++) {
            let skill = {};
            let competence = {};
            ...
            ShowDataSource_Skill_JspNeedsAssessment.addData(skill);
            ...
            ShowDataSource_Competence_JspNeedsAssessment.addData(competence, ()=>{ShowListGrid_Competence_JspNeedsAssessment.selectRecord(0)});
        }
        ShowListGrid_Competence_JspNeedsAssessment.fetchData();
        ShowListGrid_Competence_JspNeedsAssessment.emptyMessage = "<spring:message code="msg.no.records.for.show"/>";
        showDynamicForm_JspEditNeedsAssessment.setValue("objectId", objectId);
        showDynamicForm_JspEditNeedsAssessment.setValue("objectType", objectType);
        showFetchDataDomainsGrid();
    }
<%--    //**********************************************************************--%>
...
<%--            return;--%>
<%--        }--%>
<%--        if(!checkSaveData(data, ShowDataSource_Skill_JspNeedsAssessment)){--%>
<%--            createDialog("info", "<spring:message code="exception.duplicate.information"/>", "<spring:message code="error"/>");--%>
<%--            return;--%>
<%--        }--%>
<%--        ShowDataSource_Skill_JspNeedsAssessment.cacheData.unshift(data);--%>
<%--        showFetchDataDomainsGrid();--%>
<%--        hasSHowChanged = true;--%>
<%--        canSendToWorkFlowNA = true;--%>
<%--    }--%>
...
<%--        }--%>
<%--        let data = {--%>
<%--            objectType: showDynamicForm_JspEditNeedsAssessment.getValue("objectType"),--%>
<%--            objectId: showDynamicForm_JspEditNeedsAssessment.getValue("objectId"),--%>
<%--            objectName: showDynamicForm_JspEditNeedsAssessment.getItem("objectId").getSelectedRecord().titleFa,--%>
<%--            objectCode: showDynamicForm_JspEditNeedsAssessment.getItem("objectId").getSelectedRecord().code,--%>
<%--            competenceId: ShowListGrid_Competence_JspNeedsAssessment.getSelectedRecord().id,--%>
<%--            skillId: record.id,--%>
...
<%--    //**********************************************************************--%>
    ...
    function showUpdateLabelEditNeedsAssessment(objectId) {
        showLabel_PlusData_JspNeedsAssessment.setContents("");
            showLabel_PlusData_JspNeedsAssessment.setContents(
...
<%--            // if (id === undefined) {--%>
<%--            let dataForNewSkill= {};--%>
<%--            dataForNewSkill.list=ShowDataSource_Skill_JspNeedsAssessment.cacheData;--%>
...
<%--    //**********************************************************************--%>
    ...
    let ShowListGrid_SkillAll_JspNeedsAssessment_Refresh = ()=>{
        let record = ShowListGrid_Competence_JspNeedsAssessment.getSelectedRecord();
        if(record == null){
            ShowListGrid_SkillAll_JspNeedsAssessment.setData([]);
        }else{
            let cr = {};
            ...
            ShowListGrid_SkillAll_JspNeedsAssessment.setImplicitCriteria(cr);
            ShowListGrid_SkillAll_JspNeedsAssessment.invalidateCache();
            ShowListGrid_SkillAll_JspNeedsAssessment.fetchData();
        }
    }
...
<%--        ShowListGrid_Knowledge_JspNeedsAssessment.unsort();--%>
<%--        ShowListGrid_Ability_JspNeedsAssessment.unsort();--%>
<%--        ShowListGrid_Attitude_JspNeedsAssessment.unsort();--%>


<%--        if (ShowListGrid_SkillAll_JspNeedsAssessment) {--%>
<%--            ShowListGrid_SkillAll_JspNeedsAssessment.clearFilterValues();--%>
<%--        }--%>

<%--        if(state === "read"){--%>
<%--            showDynamicForm_JspEditNeedsAssessment.disable()--%>
<%--        }--%>
<%--        else {--%>
<%--            wait.show();--%>
...
<%--                    return;--%>
<%--                }--%>
<%--                updateObjectIdLG(showDynamicForm_JspEditNeedsAssessment, type);--%>
<%--                showDynamicForm_JspEditNeedsAssessment.setValue("objectType", type);--%>
<%--                showDynamicForm_JspEditNeedsAssessment.setValue("objectId", objectId.id);--%>
<%--                clearAllShowGrid();--%>
<%--                showEditNeedsAssessmentRecord(objectId.id, type);--%>
<%--                // refreshPersonnelLG(objectId);--%>
<%--                showUpdateLabelEditNeedsAssessment(objectId);--%>
<%--                if (resp.data === "true") {--%>
<%--                    readOnly(true);--%>
...
<%--            ShowListGrid_Knowledge_JspNeedsAssessment.disable();--%>
<%--            ShowListGrid_Ability_JspNeedsAssessment.disable();--%>
<%--            ShowListGrid_Attitude_JspNeedsAssessment.disable();--%>
...
<%--            showDynamicForm_JspEditNeedsAssessment.enable();--%>
<%--            CompetenceTS_needsAssessment.enable();--%>
<%--            ShowListGrid_Knowledge_JspNeedsAssessment.enable();--%>
<%--            ShowListGrid_Ability_JspNeedsAssessment.enable();--%>
<%--            ShowListGrid_Attitude_JspNeedsAssessment.enable();--%>
...
<%--                            "cId": showDynamicForm_JspEditNeedsAssessment.getValue("objectId"),--%>
<%--                            "objectName": "تغییر نیازسنجی " + priorityList[showDynamicForm_JspEditNeedsAssessment.getValue("objectType")] + " : " + showDynamicForm_JspEditNeedsAssessment.getItem("objectId").getSelectedRecord().titleFa + (showDynamicForm_JspEditNeedsAssessment.getItem("objectId").getSelectedRecord().code !== undefined ? " با کد : " + showDynamicForm_JspEditNeedsAssessment.getItem("objectId").getSelectedRecord().code : ""),--%>
<%--                            "objectType": priorityList[showDynamicForm_JspEditNeedsAssessment.getValue("objectType")],--%>
...
<%--                            "cType": showDynamicForm_JspEditNeedsAssessment.getValue("objectType")--%>
<%--                        }];--%>
<%--                        wait.show();--%>
...
<%--                            .concat(showDynamicForm_JspEditNeedsAssessment.getValue("objectId"))--%>
<%--                            .concat("&objectType=")--%>
<%--                            .concat(showDynamicForm_JspEditNeedsAssessment.getValue("objectType"));--%>
...
<%--        let data = ShowDataSource_Skill_JspNeedsAssessment.cacheData;--%>
<%--        if (data.length == 0) {--%>
...
<%--            ShowDataSource_Skill_JspNeedsAssessment.updateData(record);--%>
<%--            hasSHowChanged = true;--%>
<%--            canSendToWorkFlowNA = true;--%>
<%--            viewer.endEditing();--%>
<%--        }));--%>
...
<%--                            ShowDataSource_Skill_JspNeedsAssessment.updateData(rec);--%>
<%--                        }));--%>
<%--                    }--%>
<%--                }));--%>
<%--            }--%>
