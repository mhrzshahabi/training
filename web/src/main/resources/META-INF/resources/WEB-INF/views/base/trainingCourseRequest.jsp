...
<%--    });--%>
    ...
    <%--    let rec = JSON.parse(JSON.stringify(ListGrid_training_Managment_course_req.getSelectedRecord()));--%>
    ...
    <%--        let record = ListGrid_training_Managment_course_req.getSelectedRecord();--%>
    ...
    <%--    let recordTrManagement = ListGrid_training_Managment_course_req.getSelectedRecord();--%>
