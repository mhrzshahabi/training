...
<script>
                            ...
                            fields: [
                                {
                                    ...
                                    click: function () {
                                        ...
                                        Send_Forms_JspEvaluation.getField("sendButtonTeacher").enableIcon("ok");
                                    },
                                    icons:[
                                        {
                                            name: "ok",
                                    ...
                                    ]},
                                {
                                    ...
                                    click: function () {
                                        ...
                                        Send_Forms_JspEvaluation.getField("sendButtonTraining").enableIcon("ok");
                                    },
                                    icons:[
                                        {
                                            name: "ok",
    ...
    Send_Forms_JspEvaluation.getField("sendButtonTeacher").disableIcon("ok");
    Send_Forms_JspEvaluation.getField("sendButtonTraining").disableIcon("ok");
    //----------------------------------------- LayOut -----------------------------------------------------------------
    {
    ...
    //----------------------------------------- Functions --------------------------------------------------------------
    {
        ...
        function print_Student_Behavioral_Form_Inssuance(record){
                ...
                fields: [
                    {
                        ...
                        changed: function (form, item, value) {
                            if(value == 190)
                                EvaluationDS_PersonList.fetchDataURL =  personnelUrl + "/getParentEmployee/" + record.student.nationalCode;
                            else if(value == 189)
                                EvaluationDS_PersonList.fetchDataURL =  personnelUrl + "/getSiblingsEmployee/" + record.student.nationalCode;
                            else if(value == 454)
                                EvaluationDS_PersonList.fetchDataURL =  personnelUrl + "/getTraining/" +  "<%= SecurityUtil.getNationalCode()%>";
                            else if(value == 188)
                                EvaluationDS_PersonList.fetchDataURL =  personnelUrl + "/getStudent/" + record.student.nationalCode;
                            else
                    ...
                    isc.IButton.create({
                        ...
                        click: function () {
                            if (EvaluationListGrid_PeronalLIst.getSelectedRecord() !== null && (evaluation_Audience_Type.getValue("audiencePost") !== null && evaluation_Audience_Type.getValue("audiencePost") !== undefined)) {
                                ...
                                print_Student_FormIssuance("pdf", ealuation_numberOfStudents,record,null,evaluationType);
            ...
            EvaluationDS_PersonList.fetchDataURL =  "";
            EvaluationListGrid_PeronalLIst.dataSource = EvaluationDS_PersonList;
        ...
        function create_Student_BehavioralForm(numberOfStudents,record,evaluatorRecord,evaluatorType){
            if (ListGrid_evaluation_student.getTotalRows() > 0) {
                ...
                if (numberOfStudents === "single" && selectedStudent !== null && selectedStudent !== undefined) {
                    ...
                    data.status = false;
                    data.returnDate = evaluation_ReturnDate._value !== undefined ? evaluation_ReturnDate._value.replaceAll("/", "-") : "noDate";
        ...
        function print_Student_FormIssuance(type, numberOfStudents,record, audienceName, audienceType, formReturnDate) {
            if (ListGrid_evaluation_student.getTotalRows() > 0) {
                let selectedClass = ListGrid_evaluation_class.getSelectedRecord();
                let selectedStudent = record;
                let selectedTab = Detail_Tab_Evaluation.getSelectedTab();
                ...
                if (numberOfStudents === "all" || (numberOfStudents === "single" && selectedStudent !== null && selectedStudent !== undefined)) {
                    ...
                    criteriaForm_operational.submit(set_evaluation_status(numberOfStudents,record,audienceName, audienceType));
        ...
        function set_evaluation_status(numberOfStudents,record,audienceName, audienceType) {
