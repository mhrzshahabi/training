        ...
        fields: [
            ...
            },
            {
                ...
                , blur: function () {
                    ...
                    emailCheck = checkEmail(DynamicForm_Institute_JspInstitute.getValue("email"));
                    mailCheck = emailCheck;
                    if (emailCheck == false)
                        DynamicForm_Institute_JspInstitute.addFieldErrors("email", "<spring:message code='msg.email.validation'/>", true);

                    if (emailCheck == true)
                        DynamicForm_Institute_JspInstitute.clearFieldErrors("email", true);
                }
            },
            {
                name: "postalCode",
