...
public interface StudentClassReportViewDAO extends JpaRepository<StudentClassReportView, Long>, JpaSpecificationExecutor<StudentClassReportView> {
    ...
    @Query(value = "SELECT DISTINCT p.course_code, p.course_title_fa FROM VIEW_STUDENT_CLASSSTUDENT_CLASS_TERM_COURSE p WHERE p.course_code is not null order by p.course_code", nativeQuery = true)
    ...
    @Query(value = "SELECT DISTINCT  VIEW_STUDENT_CLASSSTUDENT_CLASS_TERM_COURSE.STUDENT_CPP_SECTION FROM VIEW_STUDENT_CLASSSTUDENT_CLASS_TERM_COURSE WHERE VIEW_STUDENT_CLASSSTUDENT_CLASS_TERM_COURSE.STUDENT_CPP_SECTION is not null order by VIEW_STUDENT_CLASSSTUDENT_CLASS_TERM_COURSE.STUDENT_CPP_SECTIONfindAll", nativeQuery = true)
