...
@Entity
@Subselect("select * from view_reaction_evaluation_formula_report_for_course")
@DiscriminatorValue("ViewReactionEvaluationFormulaReportForCourse")
public class ViewReactionEvaluationFormulaReportForCourse implements Serializable {
